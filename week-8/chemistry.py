...
def main():
    ...
    # and print the compound name for the user to see with the other output.
    ...
    print(f'{round(number_moles, 5)} moles')
...
def make_periodic_table():
    ...
    Purpose:
    The make_periodic_table function must create 
    and return a compound list that contains data 
    for all 94 naturally occuring elements.

    Return: a compound list of 94 elements
    """
    pedriodic_table_dict = {
...
def parse_formula(formula, periodic_table_dict):
    ...
    ...that stores the quantity of atoms of each element
    ...
    Return: a compound list (symbol_quantity_list) that contains chemical symbols and
        quantities like this [["Fe", 2], ["O", 3]]

        ***this compound list is known as a symbol_quantity_list because it contains 
        the symbols of chemical elements and the quantity of each element 
        that appears in a chemical formula.***
    """
    ...
    # print(list(elem_dict.items())) #added
...
def get_formula_name(formula, known_molecules_dict):
    ...
    """
    formula_name = known_molecules_dict.get(formula)
